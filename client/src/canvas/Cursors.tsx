      ...
      {collaborators
        ...
        .map((c) => (
          <Group key={c.clientId} x={c.cursor!.x} y={c.cursor!.y} scaleX={k} scaleY={k} listening={false}>
            <Line points={[0, 0, 0, 16, 4, 12, 7, 19, 10, 18, 7, 11, 12, 11]} closed fill={c.color} stroke="#fff" strokeWidth={1} />
            <Rect x={14} y={14} width={c.name.length * 12 + 12} height={20} fill={c.color} cornerRadius={4} />
