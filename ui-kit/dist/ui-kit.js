...
function backoffDelay(attempt, { baseMs = 300, maxMs = 30000, retryAfterSec = null, jitter = Math.random } = {}) {
...
function createSplit(container, { sizes, min = 100, gutter = 6, direction = 'horizontal', onChange } = {}) {
  ...
  return { createDrag, constrain, createCamera, attachPanZoom, createVirtualList, flattenTree, createHistory, registerHotkeys, debounce, substringMatch, fuzzyMatch, highlight, search, createOfflineQueue, httpError, parseRetryAfter, isTransient, backoffDelay, retry, withRetry, createLimiter, threeWayMerge, wordDiff, diffToHtml, createPersistentStore, createSyncChannel, activateFocusTrap, computePosition, positionAtPoint, createToaster, createSortable, createSplit };
});
